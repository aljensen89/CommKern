...
P[1:10,11:20] <- P[1:10,11:20]*1.3
P[11:20,1:10] <- P[11:20,1:10]*1.3

P[21:30,31:40] <- P[21:30,31:40]*1.1
P[31:40,21:30] <- P[31:40,21:30]*1.1

P[41:50,51:60] <- P[41:50,51:60]*0.9
P[51:60,41:50] <- P[51:60,41:50]*0.9

P[61:70,71:80] <- P[61:70,71:80]*0.8
P[71:80,61:70] <- P[71:80,61:70]*0.8

#Making changes to layer 1:
P[1:20,21:40] <- P[1:20,21:40]*1.8
P[21:40,1:20] <- P[21:40,1:20]*1.8
...
SBM_net <- matrix_to_df(A_func,A_str) #gen_P(n=80,d=3,a.seq=0.33^seq(0,3),lambda=10)
